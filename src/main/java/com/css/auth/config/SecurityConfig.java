...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Pattern "*" with credentials is invalid in browsers; use reflection-friendly open CORS without cookies.
        boolean openWildcard = patterns.size() == 1 && "*".equals(patterns.get(0));
        configuration.setAllowCredentials(!openWildcard);
